...
using static PageBuilder.StringHelper;
using System.Net;
...
namespace PageBuilder
{
    ...
    public class MCVersions
    {
        ...
        {
#if Client
            string response = NewsHomepageHelper.HttpHelper.GetHttpStringResponseString(url);
            ...
            Log("读取成功",2);
#else
            throw new NotImplementedException("啥玩意啊，服务器还读？");
#endif
        }
